...
export default class Video extends Observable(Embed) {
  ...
  static get template() {
    return `
      <style>${CSS}</style>
      <button type="button" id="playbutton" title="By playing this video you agree to YouTube/Facebook/Vimeo or Twitter's use of cookies. This use may include analytics, personalization, and ads.">
